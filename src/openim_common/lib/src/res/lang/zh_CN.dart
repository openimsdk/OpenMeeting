const Map<String, String> zh_CN = {
  ...
  'allowMembersEnterFirst': '允许成员在主持人进会前入会',
  'endsIn': '结束于',
  'enterMeeting': '进入会议',
  'meetingNo': '会议号',
  'wrongMeetingNo': '会议号错误',
  'meetingInvitedUrl': '邀请链接',
  'yourMeetingName': '我的名称',
  'enterMeetingPassword': '入会密码',
  'enterMeetingPasswordHint': '无密码可不填',
  'wrongMeetingPassword': '密码错误',
  ...
  'emptyMeeting': '暂无会议',
  'me': '我',
  'meetingRoomSetting': '会议管控',
  'enterMeetingEnableMicrophone': '入会开启麦克风',
  'enterMeetingEnableVideo': '入会开启摄像头',
  'customRepeatModelHint': '会议将每%s重复',
  'noRepeat': '不重复',
  'daily': '每天',
  'weekday': '工作日',
  'weekly': '每周',
  ...
  'enterMeetingSetting': '入会设置',
  'Nth': '第%s个',
  'meetingHistory': '历史会议',
  'requestEnableAudio': '请求开启语音',
  'requestEnableVideo': '请求开始视频',
  'changeNickname': '修改名称',
  'kickoffFromMeeting': '请出会议',
  'setHost': '设为主持人',
