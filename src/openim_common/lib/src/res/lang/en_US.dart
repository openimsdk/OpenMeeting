const Map<String, String> en_US = {
  ...
  'allowMembersEnterFirst': 'Member enter first',
  'endsIn': 'Ends in',
  'enterMeeting': 'Enter Meeting',
  'meetingNo': 'Number',
  'wrongMeetingNo': 'Wrong Meeting Number',
  'meetingInvitedUrl': 'Invited URL',
  'yourMeetingName': 'My Name',
  'enterMeetingPassword': 'Enter Meeting Password',
  'enterMeetingPasswordHint': 'If there is no password, please leave it blank.',
  ...
  'enableSpeaker': 'Turn on speakers',
  'enableVideo': 'Turn on video',
  'videoMirror': 'video mirroring',
  'emptyMeeting': 'No meetings yet',
  'me': 'Me',
  'meetingRoomSetting': 'Room Setting',
  'enterMeetingEnableMicrophone': 'Enter meeting enable microphone',
  'enterMeetingEnableVideo': 'Enter meeting enable camera',
  'customRepeatModelHint': 'The meeting will repeat every %s',
  'noRepeat': 'No Repeat',
  'daily': 'Daily',
  'weekday': 'Weekday',
  'weekly': 'Weekly',
  'biweekly': 'Biweekly',
  'monthly': 'Monthly',
  'endsInHit': '%s meetings on %s',
  'times': '%s times',
  'meetingSubject': 'Conference theme',
  'occurrences': 'Occurrences',
  'securitySetting': 'Security Settings',
  'enterMeetingSetting': 'Enter Meeting Settings',
  'Nth': '%sth',
  'meetingHistory': 'History',
  'requestEnableAudio': 'Request Enable Audio',
  'requestEnableVideo': 'Request Enable Video',
  'changeNickname': 'Change Nickname',
  'kickoffFromMeeting': 'Kick off from meeting',
  'setHost': 'Set Host',
  ...
  '200004': 'Meeting update check error',
