...
class StrRes {
  ...
  static String get repeatFrequency => 'repeatFrequency'.tr;

  static String get allowMembersEnterFirst => 'allowMembersEnterFirst'.tr;

  static String get endsIn => 'endsIn'.tr;

  static String get enterMeeting => 'enterMeeting'.tr;

  static String get meetingNo => 'meetingNo'.tr;

  static String get wrongMeetingNo => 'wrongMeetingNo'.tr;

  static String get meetingInvitedUrl => 'meetingInvitedUrl'.tr;

  static String get yourMeetingName => 'yourMeetingName'.tr;

  static String get enterMeetingPassword => 'enterMeetingPassword'.tr;

  static String get enterMeetingPasswordHint => 'enterMeetingPasswordHint'.tr;

  static String get wrongMeetingPassword => 'wrongMeetingPassword'.tr;
  ...
  static String get meetingHost => 'meetingHost'.tr;

  static String get meetingNoIs => 'meetingNoIs'.tr;

  static String get meetingJoinDuration => 'meetingJoinDuration'.tr;
  ...
  static String get conversation => 'conversation'.tr;
  static String get enter => 'enter'.tr;
  static String get enableMicrophone => 'enableMicrophone'.tr;
  static String get enableSpeaker => 'enableSpeaker'.tr;
  static String get enableVideo => 'enableVideo'.tr;
  static String get videoMirror => 'videoMirror'.tr;
  static String get emptyMeeting => 'emptyMeeting'.tr;

  static String get me => 'me'.tr;
  static String get meetingRoomSetting => 'meetingRoomSetting'.tr;
  static String get enterMeetingEnableMicrophone => 'enterMeetingEnableMicrophone'.tr;
  static String get enterMeetingEnableVideo => 'enterMeetingEnableVideo'.tr;
  static String get customRepeatModelHint => 'customRepeatModelHint'.tr;
  static String get noRepeat => 'noRepeat'.tr;
  static String get daily => 'daily'.tr;
  static String get weekday => 'weekday'.tr;
  static String get weekly => 'weekly'.tr;
  static String get biweekly => 'biweekly'.tr;
  static String get monthly => 'monthly'.tr;
  static String get endsInHit => 'endsInHit'.tr;
  static String get times => 'times'.tr;
  static String get meetingSubject => 'meetingSubject'.tr;
  static String get occurrences => 'occurrences'.tr;
  static String get securitySetting => 'securitySetting'.tr;
  static String get enterMeetingSetting => 'enterMeetingSetting'.tr;
  static String get Nth => 'Nth'.tr;
  static String get meetingHistory => 'meetingHistory'.tr;
  static String get requestEnableAudio => 'requestEnableAudio'.tr;
  static String get requestEnableVideo => 'requestEnableVideo'.tr;
  static String get changeNickname => 'changeNickname'.tr;
  static String get kickoffFromMeeting => 'kickoffFromMeeting'.tr;
  static String get setHost => 'setHost'.tr;
